        ...
        <div className="border-solid border-6 border-white dark:bg-strokedark border-opacity-50 rounded-xl shadow-lg">
          ...
          <div className="ganhadores-txt-txt">
            <p className="py-3 px-3">
              ...
              prêmios incríveis em nossos sorteios recentes. Parabenizamos a
              todos todos os vencedores por sua incrível conquista! 🤩
            </p>
            <p className="py-3 px-3">
            ...
            <p className="py-3 px-3">
              Acompanhe nossas redes sociais e fique atento as próximas
              campanhas. Sua oportunidade de ganhar um prêmio incrível pode
